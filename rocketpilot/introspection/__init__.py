...
from rocketpilot.introspection.dbus import DBusIntrospectionObject, is_element
from rocketpilot.introspection._xpathselect import (
...
ProxyBase = DBusIntrospectionObject
