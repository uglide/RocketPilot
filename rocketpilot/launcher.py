...
import rocketpilot.constants as constants
...
def launch_test_application(application, *arguments, **kwargs):
    ...
    launcher = ApplicationLauncher(**kwargs)
...
class ApplicationLauncher(object):
    ...
    def launch(self, application, arguments=None, launch_dir=None, capture_output=True):
